...
import Styles from './RecycledPikup.module.scss';
...
export default function RecycledPikup() {
                ...
                <div className={Styles.Recycled} onClick={showInfo}>
                    <div className={Styles.recycledLeft}>
                        ...
                        <div className={Styles.middle}>
                            ...
                            <div className={Styles.donatedText}>
                                ...
                                <Text className={Styles.donateText} color={"primary2"} variant={"xsText"} strong={"strong7"}> donated </Text>
                    ...
                    <div className={Styles.RecycledMiddle} >
                        <div className={Styles.middleRight} >
                            <div className={Styles.top} ><Text variant={"msmText"} strong={"strong6"} >Pickup</Text> </div>
                    ...
                    <div className={Styles.RecycledMiddle}>
                            <div className={Styles.middleRight}>
                                ...
                                <div className={Styles.recycledRight}>
                                    <div><Icon customClass={Styles.alertIcon} type="iconalert" /></div>
                                    <div className={Styles.noText}><Text variant={"xsText"} color={"redPrimary"}>1 contaminated item!</Text></div>
                                </div>
                            </div>
                        </div>
                </div>
                <div className={Styles.clickbottom}>
                    ...
                    <div className={Styles.donated}>
                        <div className={Styles.donatedBoxmain}>
                            ...
                            <div className={Styles.donatedText}>
                                <Icon customClass={Styles.iconForward} type="iconforward" />
                                <Text variant={"xsText"} color={"ecoPrimary"} strong={"strong7"}> donated </Text>
                            </div>
                        </div>
                        <div><Text variant={"xsText"} color={"grayPrimary"} strong={"strong4"}>Transaction ID 2378462</Text></div>
                    </div>
